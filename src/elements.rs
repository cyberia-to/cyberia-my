//! Elements + BOM transform — production chain UI.
...
pub fn ElementsPage() -> impl IntoView {
    ...
    Effect::new(move |_| {
        document().set_title("Cyberia — elements · BOM");
        ensure_economy_boot();
        tick.update(|n| *n += 1);
    });
        ...
        <div class="page-shell cities-shell">
            ...
            <div class="cities-stage">
                <div class="cities-hero">
                    <div>
                        <div class="cities-kicker">"PRODUCTION LOOP"</div>
                        <h2 class="cities-title">"Elements · BOM"</h2>
                        <p class="cities-lead">
                            "Primitives and products. BOM chains transform stocks — no orgs, just inputs → outputs. Trade the result on Market."
                        </p>
                    </div>
                </div>
